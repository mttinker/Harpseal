...
pl10 = ggplot(dp10,aes(x=Ice_Anomaly,y=SvIce)) +
  ...
  ggtitle("Figure 7. Effect of ice cover on pup survival (Gulf)") +
  theme_classic()
print(pl10)
```
