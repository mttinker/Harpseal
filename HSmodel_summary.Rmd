...
kable(statsum,digits=3,caption='\\textbf{Table 2: Statistics for fitted parameters}')
```
...
row.names(Ktab) = NULL
kable(Ktab,digits=3,
      caption='\\textbf{Table 3: Current abundance and estimated potential equilibrium abundance (K) in millions of animals}')
```
...
kable(TACtab,digits=3,
      caption='\\textbf{Table 4: Recomended TAC values (in thousands of animals)}')
```
