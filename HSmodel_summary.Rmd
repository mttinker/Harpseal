...
required_Packages<-c("knitr","readxl", "gtools", "stats", "dplyr", "ggplot2", "fitdistrplus", "lattice","coda","bayesplot","foreach","doParallel")
...
where $${\varepsilon _F}(t)\sim normal\left( {0,{\sigma _F}} \right)$$ and where $\beta$, $\phi_F$, $\delta$, and $\sigma_F$ are all parameters to be fit.  Environmental index (*CE*) values were log-transformed, which both normalized and resulted in a mean value (for 1951-2019) of approximately 0.
...
<<<<<<< HEAD
$${S_P}(t) = 1 - \left( {\frac{{logi{t^{ - 1}}\left[ {z(t)} \right]}}{{10}}} \right)$$
=======
$${S_P}(t) = 1 - \left( {{{logi{t^{ - 1}}\left[ {z(t)} \right]} \over {10}}} \right)$$
>>>>>>> 9147dfe46a99ed3511404b91beb0d43ff0013e3a
...
<<<<<<< HEAD
$${\gamma _I}(b,t) = {\psi _1} \cdot {\left( {\frac{1}{{\exp \left( {IC(b,t)} \right)}}} \right)^{{\psi _2}}} - 1$$
=======
...
<<<<<<< HEAD
$$Agedist\_pred(t) = \frac{{\left[ {\begin{array}{*{20}{c}}
{n(3,t)}&{n(4,t)}&{...}&{n(A,t)}
\end{array}} \right]}}{{\sum\limits_{a = 3}^A {n(a,t)} }}$$
...
<<<<<<< HEAD
$${f_{HVJ}}(t) = \frac{{{h_{HVJ}}(t)}}{{\left[ {{h_J}(t) + {h_{HVJ}}(t) + {h_I}(t)} \right]}}$$
...
$${f_{HVA}}(t) = \frac{{{h_{HVA}}(t)}}{{\left[ {{h_A}(t) + {h_{HVA}}(t)} \right]}}$$
=======
...
```{r Fig1, echo=FALSE, warning=FALSE, out.width='120%'}
PR1966 = sumstats[startsWith(vns,"Fc8_prdct[")==T,1][16]
PR1966per = mean(sumstats[startsWith(vns,"Fc8_prdct[")==T,1][1:32],na.rm = T)
crct1 = PR1966per/PR1966
PR2016 = sumstats[startsWith(vns,"Fc8_prdct[")==T,1][66]
...
```{r Fig2, echo=FALSE, warning=FALSE, out.width='120%'}
>>>>>>> 9147dfe46a99ed3511404b91beb0d43ff0013e3a
NN = seq(.2,5,by=0.1)
...
=======
```{r Fig3, echo=FALSE, warning=FALSE, out.width='120%'}
>>>>>>> 9147dfe46a99ed3511404b91beb0d43ff0013e3a
NN = seq(.2,10,by=0.1)
aJr = Jvloghz 
...
=======
```{r Fig4, echo=FALSE, warning=FALSE, out.width='120%'}
>>>>>>> 9147dfe46a99ed3511404b91beb0d43ff0013e3a
...
=======
```{r Fig5, echo=FALSE, warning=FALSE, out.width='120%'}
>>>>>>> 9147dfe46a99ed3511404b91beb0d43ff0013e3a
...
=======
```{r Fig6, echo=FALSE, warning=FALSE, out.width='120%'}
>>>>>>> 9147dfe46a99ed3511404b91beb0d43ff0013e3a
...
=======
```{r Fig7, echo=FALSE, warning=FALSE, out.width='120%'}
>>>>>>> 9147dfe46a99ed3511404b91beb0d43ff0013e3a
...
=======
```{r Fig8, echo=FALSE, warning=FALSE, out.width='120%'}
>>>>>>> 9147dfe46a99ed3511404b91beb0d43ff0013e3a
...
=======
```{r Fig9, echo=FALSE, warning=FALSE, out.width='120%'}
>>>>>>> 9147dfe46a99ed3511404b91beb0d43ff0013e3a
...
# Sims to estimate K
futuresim = 1; Nyrs2 = 50; Yearst2 = 2020 ; reps = 20000
...
P_end = sumstats[which(vns==paste0("N[",Nyrs,"]")),1]
YY = 2000
...
=======
                  Adloghz=Adloghz,Jvloghz=Jvloghz,gamm0=gamm0) 
>>>>>>> 9147dfe46a99ed3511404b91beb0d43ff0013e3a
init_fun <- function() {list(sigF=rnorm(1,sumstats[vns=="sigF",1],sumstats[vns=="sigF",2]),                  sigH=rnorm(1,sumstats[vns=="sigH",1],sumstats[vns=="sigH",2]), phiJ=rnorm(1,sumstats[vns=="phiJ",1],sumstats[vns=="phiJ",2]), phiF=rnorm(1,sumstats[vns=="phiF",1],sumstats[vns=="phiF",2]),
...
```{r Table3, echo=FALSE}
<<<<<<< HEAD
Ktab = data.frame(Metric = "Current abundance",
...
Ktab = rbind(Ktab, data.frame(Metric = "Equilibrium abundance",
...
<<<<<<< HEAD
      caption="Table 4: Recommended TAC values (in thousands of animals)")
=======
